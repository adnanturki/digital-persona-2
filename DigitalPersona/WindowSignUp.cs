...
namespace DigitalPersona
{
	public partial class WindowSignUp : Form, DPFP.Capture.EventHandler
	{
		...
		private void buttonReset_Click( object sender, EventArgs e )
		{
			...
			labelCount.Text = "You need to swipe 4 times";
			inputName.Text = "";
		...
		public void Init()
		{
			try
			{
				...
				{
					MessageBox.Show( "DIGITAL-PERSON STARTING ERROR" );
				}
			}
			catch( Exception e )
			{
		...
		public void StopCapture()
		{
			if( capture != null )
			{
				...
				{
					MessageBox.Show( "ERROR WHEN STOPPING DIGITAL-PERSON" );
				}
			}
		}
		...
		/// DELEGATES - ENSURE THAT THE CONTEXT IS THAT OF THE MAIN THREAD ///
