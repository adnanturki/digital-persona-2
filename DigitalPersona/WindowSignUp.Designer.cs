namespace DigitalPersona
{
    partial class WindowSignUp
    {
        ...
        private void InitializeComponent()
        {
			...
			this.labelCount.Size = new System.Drawing.Size(163, 16);
			this.labelCount.TabIndex = 1;
			this.labelCount.Text = "You need to swipe 4 times";
			// 
			// buttonSave
			// 
			...
			this.labelMessage.Size = new System.Drawing.Size(183, 33);
			this.labelMessage.TabIndex = 5;
			this.labelMessage.Text = "User register";
			// 
			// buttonReset
			// 
			...
			this.buttonReset.Text = "Add Other";
			...
			this.buttonLogin.Text = "Start Sesion";
